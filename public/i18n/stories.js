...
// writer to fill in, one entry per card, same shape: { zh, en, src }. A card
// with no entry here shows no history section at all (see card-view.js).
export default {
  zhangyi: {
