...
export default {
  ...
  miezhou: {
    zh: "前256年,西周君背秦與諸侯合縱,秦昭襄王大怒,遣將攻西周。西周君奔秦頓首請罪,獻出三十六邑、三萬人口,秦受其獻;同年周赧王去世,九鼎等寶器也隨之入秦。《史記·秦本紀》稱此為「周初亡」,東周的殘餘勢力要到前249年才真正被秦所滅。",
    en: "In 256 BC, the ruler of Western Zhou broke with Qin and joined a coalition of other states, and an enraged King Zhao of Qin sent an army against him. The ruler surrendered, kowtowing and offering thirty-six settlements and thirty thousand people; Qin accepted, King Nan of Zhou died that year, and the Nine Cauldrons passed to Qin with the rest. The Shiji calls this the start of Zhou's end, though the remaining Eastern Zhou state was not destroyed until 249 BC.",
    srcZh: "《史記·周本紀》、《史記·秦本紀》",
    srcEn: "Shiji, Basic Annals of Zhou; Basic Annals of Qin",
  },
  lvbuwei: {
    zh: "前250年,呂不韋為秦相國,封文信侯。他召集門下食客編纂《呂氏春秋》,匯集八覽、六論、十二紀,二十餘萬言。書成後,呂不韋將全書懸掛於咸陽城門,佈告能增損一字者賞千金,以此顯示此書完備,「一字千金」的說法即由此而來。",
    en: "In 250 BC, Lü Buwei became chancellor of Qin and was made Lord Wenxin. He gathered his household scholars to compile the Lüshi Chunqiu, over two hundred thousand words across eight surveys, six discourses, and twelve almanacs. Once finished, he hung the text at a gate of Xianyang and offered a thousand gold pieces to anyone who could add or remove a single word, to show how complete it was; the phrase \"a thousand gold for one word\" comes from this.",
    srcZh: "《史記·呂不韋列傳》",
    srcEn: "Shiji, Biography of Lü Buwei",
  },
  zhengguoqu: {
    zh: "前246年,韓國派水工鄭國游說秦國修建大型灌溉渠道,實為「疲秦之計」,想藉此消耗秦國國力。工程中途,鄭國的間諜身分被識破,秦王欲殺之,鄭國辯稱「渠成亦秦之利」,秦王認為有理,命他繼續完工。渠成後關中沃野千里,秦國反而因此更加富強,渠因此得名鄭國渠。",
    en: "In 246 BC, Han sent the engineer Zheng Guo to persuade Qin to build a great irrigation canal, actually a scheme to drain Qin's resources and keep it from attacking. Partway through, Qin discovered he was a spy and wanted to execute him; he argued the canal would still benefit Qin regardless, and the king let him finish it. Once built, the canal turned Guanzhong fertile for a thousand li, making Qin richer rather than weaker, and it was named after him.",
    srcZh: "《史記·河渠書》",
    srcEn: "Shiji, Treatise on Rivers and Canals",
  },
  fanjian: {
    zh: "前260年,秦趙相持於長平,廉頗堅壁不出。秦人使人赴趙散布流言:「秦之所畏,獨畏馬服君之子趙括為將耳。」趙孝成王信以為真,遂以趙括代廉頗為將,而後趙括冒進兵敗,四十萬趙軍覆沒。這是戰國反間計裡最具決定性的一次。",
  ...
  maosui: {
    zh: "前257年,秦圍邯鄲,趙求救於楚,平原君挑二十名門客同赴楚國,只湊足十九人,毛遂自薦。平原君以「錐處囊中,其末立見」質疑他未曾露鋒,毛遂答以「使遂蚤得處囊中,乃脫穎而出」。至楚,毛遂按劍直陳利害,終於說動楚王救趙,平原君因此稱他「三寸之舌,強於百萬之師」。",
    en: "In 257 BC, with Qin besieging Handan, Zhao appealed to Chu, and Lord Pingyuan chose twenty retainers, finding only nineteen worth taking until Mao Sui volunteered himself. Pingyuan doubted him, since a capable man, like an awl in a sack, should show its point by now; Mao Sui answered he was only now asking to be placed in the sack. In Chu he argued bluntly until the king agreed to send troops, and Pingyuan called his tongue mightier than a hundred thousand soldiers.",
    srcZh: "《史記·平原君虞卿列傳》",
    srcEn: "Shiji, Biographies of Lord Pingyuan and Yu Qing",
  },
  lianpo: {
    zh: "廉頗與李牧都是趙國後期名將。前260年前,廉頗堅壁固守長平,擋住秦軍三年之久,後因趙王中反間計換下才致慘敗。李牧常年鎮守北疆雁門,大破匈奴十餘萬騎,又屢次擊退秦軍。前229年,趙王遷聽讒言處死李牧,三個月後趙國即為秦所滅,後世常以此感嘆李牧一死、趙國隨之覆亡。",
    en: "Lian Po and Li Mu were both late Zhao generals. Before 260 BC, Lian Po held Changping against Qin for three years by refusing battle, before being replaced through a rumor, leading to disaster. Li Mu guarded the north at Yanmen for years, crushing a hundred thousand Xiongnu horsemen, and beat back Qin's armies too. In 229 BC, King Qian of Zhao had Li Mu executed on false charges, and Zhao fell to Qin three months later, a sequence long called cause and effect.",
    srcZh: "《史記·廉頗藺相如列傳》",
    srcEn: "Shiji, Biographies of Lian Po and Lin Xiangru",
  },
  chunshenjun: {
    zh: "黃歇是楚國貴族,楚考烈王時為相,號春申君,廣納門客三千餘人,是戰國四公子之一。他曾隨太子完(即後來的考烈王)在秦國為質多年,用計讓太子詐扮楚國使者的車夫出關逃歸,自己則稱病留守,助太子順利繼位為王。晚年因門客李園設計,春申君遭刺客斬殺於棘門。",
    en: "Huang Xie was a Chu noble, chancellor under King Kaolie, known as Lord Chunshen, one of the Four Lords of the Warring States, with thousands of retainers. He once went with the crown prince, later King Kaolie, as a hostage in Qin, and had the prince slip out disguised as his own driver while he stayed behind pleading illness, letting the prince return to Chu and take the throne. Late in life, his retainer Li Yuan had him assassinated at the palace gate.",
    srcZh: "《史記·春申君列傳》",
  ...
  lixin: {
    zh: "前225年,秦王政問李信伐楚需兵若干,李信答二十萬即可,遂與蒙恬率二十萬兵伐楚,初期連戰連捷,攻破平輿、鄢郢。李信西向與蒙恬會師城父,楚將項燕率軍尾隨三日三夜不曾休整,突襲李信軍,大破之,斬殺秦軍七都尉。〈秦始皇本紀〉未提此敗,本文從〈白起王翦列傳〉。",
    en: "In 225 BC, King Zheng of Qin asked Li Xin how many troops he needed to conquer Chu; he said two hundred thousand, and led that force south with Meng Tian, winning early victories at Pingyu and old Ying. Turning west, he was shadowed for three days and nights by the Chu general Xiang Yan's army, then ambushed and crushed, losing seven commanders. The Annals of the First Emperor skips this defeat; this follows the Biography of Bai Qi and Wang Jian.",
    srcZh: "《史記·白起王翦列傳》",
    srcEn: "Shiji, Biographies of Bai Qi and Wang Jian",
  },
  duojiang: {
  ...
  zhukeling: {
    zh: "前237年,鄭國渠被揭穿是間諜之計,加上此前呂不韋、嫪毐等外來勢力干政的教訓,秦國宗室大臣進言:「諸侯人來事秦者,大抵為其主游間於秦耳,請一切逐客。」秦王政於是下令,凡非秦國出身的客卿一律驅逐出境,聲勢浩大,史稱逐客令。",
    en: "In 237 BC, after the Zhengguo Canal was exposed as a spying scheme, and with the earlier troubles of Lü Buwei and Lao Ai fresh in mind, Qin's own nobles told the king that outsiders who came to serve Qin mostly worked for their home states, so all such guests should be expelled. King Zheng of Qin issued an order expelling every official not born in Qin, a sweeping purge remembered as the Expulsion of Foreigners.",
    srcZh: "《史記·李斯列傳》",
    srcEn: "Shiji, Biography of Li Si",
  },
  dunbing: {
