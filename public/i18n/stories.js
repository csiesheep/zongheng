...
export default {
  ...
  lvbuwei: {
    zh: "前250年,呂不韋為秦相國,封文信侯。他召集門下食客編纂《呂氏春秋》,匯集八覽、六論、十二紀,二十餘萬言。書成後,呂不韋將全書懸掛於咸陽城門,佈告能增損一字者賞千金,以此顯示此書完備,後人因此以一字千金形容此事。",
    en: "In 250 BC, Lü Buwei became chancellor of Qin and was made Lord Wenxin. He gathered his household scholars to compile the Lüshi Chunqiu, over two hundred thousand words across eight surveys, six discourses, and twelve almanacs. Once finished, he hung the text at a gate of Xianyang and offered a thousand gold pieces to anyone who could add or remove a single word, to show how complete it was, giving later writers a byword for an unimprovable text.",
    srcZh: "《史記·呂不韋列傳》",
    srcEn: "Shiji, Biography of Lü Buwei",
  },
  zhengguoqu: {
  ...
  maosui: {
    zh: "前257年,秦圍邯鄲,趙求救於楚,平原君挑二十名門客同赴楚國,只湊足十九人,毛遂自薦。平原君以「錐處囊中,其末立見」質疑他未曾露鋒,毛遂答以「使遂蚤得處囊中,乃穎脫而出」。至楚,毛遂按劍直陳利害,終於說動楚王救趙,平原君因此稱他「三寸之舌,強於百萬之師」。",
