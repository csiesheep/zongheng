...
export default {
  ...
  tutorial: {
    ...
    steps: {
      ...
      control: { title: "控制", text: "控制 = 我方影響力 ≥ 對方 + 安定值。{space}:{qin} ≥ {chu} + {stability},是你的;上限 +2。", do: "點{space}" },
      hand: { title: "手牌", text: "圓形徽章是點數;黑是秦的事件、紅是楚的、白是中立的。一張牌有四種用法,先學最簡單的:放置。", do: "點亮著的牌" },
      place: { title: "放置", text: "每點花 1,放己方影響力處或控制據點旁;對方處每點 2。{space} 放 {n}:{qin}≥{chu}+{stability}。", do: "點{space} {n} 次" },
      ...
      campaign: { title: "征伐", text: "打有對方影響力的據點:最多移除 {n} 點,剩下的變成我方的。打要衝,疲敝 +1;推到{to}的人輸。", do: "確認征伐{space}" },
