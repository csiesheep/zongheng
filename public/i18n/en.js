...
export default {
  ...
  advisor: {
    ...
    suggestCard: "Play {card}: {use} {space}",
    suggestUse: "Use it to {use}",
    ...
    reasons: {
      ...
      nearDestroy: "{state} is {n} spaces from falling.",
      ...
      dumpEnemyEvent: "Bog this enemy card now. Its event does the least damage here.",
