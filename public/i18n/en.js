...
export default {
  ...
  tutorial: {
    ...
    steps: {
      ...
      hand: { title: "Your hand", text: "The round badge is the card's points. Black carries Qin's event, red Chu's, white nobody's. A card has four uses; start with the simplest, place.", do: "Tap the lit card" },
      place: { title: "Place", text: "1 op places 1 point, only where you already stand or next to your control; 2 ops per point into enemy control. {n} into {space}: {qin} is at least {chu} plus {stability} — yours.", do: "Tap {space} {n} times" },
