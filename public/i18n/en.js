...
export default {
  ...
  landing: { backToRoom: "Back to room {code}", resume: "Resume your game", play: "Play vs bot", random: "Random side", multiplayer: "Multiplayer", create: "Create a room", join: "Join", code: "Room code", codePlaceholder: "CODE", rulesLink: "Rules and the 72 cards", name: "Your name" },
  side: {
